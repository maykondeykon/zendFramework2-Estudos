 ...
 */
class Area extends \Application\Model\Area implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Model\\Area' . "\0" . '_id', '' . "\0" . 'Application\\Model\\Area' . "\0" . '_nome');
        }
